namespace SoftUni.Blog.App.Areas.Admin.Controllers
{
    ...
    public class PostsController : BaseAdminController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Content,AuthorId,SentToDate")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Content,SentToDate,AuthorId")] Post post)
        {
            if (ModelState.IsValid)
            {
                ...
                foundPost.SentToDate = post.SentToDate;
                foundPost.AuthorId = foundPost.AuthorId;

...
namespace Bookstore.Services
{
    public class BookService : Service
    {
        ...
        private double CalculateAvgRating(List<Rating> ratings)
        {
            double avgRating = 0;
        ...
        private int GetCurrentUserRatingValue(List<Rating> ratings, string currUserId)
        {
            int ratingValue = 0;
        ...
        private bool CheckIfCurrentUserRated(List<Rating> ratings, string currUserId)
        {
            bool isRated = false;
            foreach (var rating in ratings)
            {
